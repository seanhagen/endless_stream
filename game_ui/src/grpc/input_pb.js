...
goog.exportSymbol('proto.endless.stream.v1.Input.InputCase', null, global);
goog.exportSymbol('proto.endless.stream.v1.LevelUp', null, global);
...
proto.endless.stream.v1.UseSkill = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.endless.stream.v1.UseSkill.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.endless.stream.v1.LevelUp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.endless.stream.v1.LevelUp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.endless.stream.v1.LevelUp.displayName = 'proto.endless.stream.v1.LevelUp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.Register} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.CharSelect} returns this
 */
 ...
 * @const
 */
proto.endless.stream.v1.UseSkill.repeatedFields_ = [2];
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.UseSkill} returns this
 */
 ...
 * @return {!Array<string>}
 */
proto.endless.stream.v1.UseSkill.prototype.getTargetIdsList = function() {
 ...
 * @return {!proto.endless.stream.v1.UseSkill} returns this
 */
proto.endless.stream.v1.UseSkill.prototype.setTargetIdsList = function(value) {
 ...
 * @return {!proto.endless.stream.v1.UseSkill} returns this
 */
proto.endless.stream.v1.UseSkill.prototype.addTargetIds = function(value, opt_index) {
 ...
 * @return {!proto.endless.stream.v1.UseSkill} returns this
 */
proto.endless.stream.v1.UseSkill.prototype.clearTargetIdsList = function() {
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.UseItem} returns this
 */
 ...
 * @return {!proto.endless.stream.v1.Move} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.ActionComplete} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.Purchase} returns this
 */
 ...
 * @return {!Object}
 */
proto.endless.stream.v1.LevelUp.prototype.toObject = function(opt_includeInstance) {
  return proto.endless.stream.v1.LevelUp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.endless.stream.v1.LevelUp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.endless.stream.v1.LevelUp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.endless.stream.v1.LevelUp}
 */
proto.endless.stream.v1.LevelUp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.endless.stream.v1.LevelUp;
  return proto.endless.stream.v1.LevelUp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.endless.stream.v1.LevelUp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.endless.stream.v1.LevelUp}
 */
proto.endless.stream.v1.LevelUp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.endless.stream.v1.LevelUp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.endless.stream.v1.LevelUp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.endless.stream.v1.LevelUp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.endless.stream.v1.LevelUp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
...
/**
 * @param {boolean} value
 * @return {!proto.endless.stream.v1.AudienceYell} returns this
 */
 ...
 * @const
 */
proto.endless.stream.v1.Input.oneofGroups_ = [[10,20,30,40,50,60,70,80,81,90,100,110]];
...
proto.endless.stream.v1.Input.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    levelUp: (f = msg.getLevelUp()) && proto.endless.stream.v1.LevelUp.toObject(includeInstance, f),
...
proto.endless.stream.v1.Input.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 80:
      ...
      break;
    case 81:
      var value = new proto.endless.stream.v1.LevelUp;
      reader.readMessage(value,proto.endless.stream.v1.LevelUp.deserializeBinaryFromReader);
...
proto.endless.stream.v1.Input.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      81,
      f,
      proto.endless.stream.v1.LevelUp.serializeBinaryToWriter
    );
  }
...
/**
 * @param {string} value
 * @return {!proto.endless.stream.v1.Input} returns this
 */
...
proto.endless.stream.v1.Input.prototype.setRegister = function(value) {
  return jspb.Message.setOneofWrapperField(this, 10, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setCharSelect = function(value) {
  return jspb.Message.setOneofWrapperField(this, 20, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.clearCharSelect = function() {
  return this.setCharSelect(undefined);
};
...
proto.endless.stream.v1.Input.prototype.setGameStart = function(value) {
  return jspb.Message.setOneofWrapperField(this, 30, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setSkill = function(value) {
  return jspb.Message.setOneofWrapperField(this, 40, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setItem = function(value) {
  return jspb.Message.setOneofWrapperField(this, 50, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setMove = function(value) {
  return jspb.Message.setOneofWrapperField(this, 60, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setActionComplete = function(value) {
  return jspb.Message.setOneofWrapperField(this, 70, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.clearActionComplete = function() {
  return this.setActionComplete(undefined);
};
...
proto.endless.stream.v1.Input.prototype.setPurchase = function(value) {
  return jspb.Message.setOneofWrapperField(this, 80, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
/**
 * optional LevelUp level_up = 81;
 * @return {?proto.endless.stream.v1.LevelUp}
 */
proto.endless.stream.v1.Input.prototype.getLevelUp = function() {
  return /** @type{?proto.endless.stream.v1.LevelUp} */ (
    jspb.Message.getWrapperField(this, proto.endless.stream.v1.LevelUp, 81));
};


/**
 * @param {?proto.endless.stream.v1.LevelUp|undefined} value
 * @return {!proto.endless.stream.v1.Input} returns this
*/
proto.endless.stream.v1.Input.prototype.setLevelUp = function(value) {
  return jspb.Message.setOneofWrapperField(this, 81, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
 ...
 * @return {!proto.endless.stream.v1.Input} returns this
 */
proto.endless.stream.v1.Input.prototype.clearLevelUp = function() {
  return this.setLevelUp(undefined);
};
 ...
 * @return {boolean}
 */
proto.endless.stream.v1.Input.prototype.hasLevelUp = function() {
...
proto.endless.stream.v1.Input.prototype.setContinue = function(value) {
  return jspb.Message.setOneofWrapperField(this, 90, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.clearContinue = function() {
  return this.setContinue(undefined);
};
...
proto.endless.stream.v1.Input.prototype.setEndGame = function(value) {
  return jspb.Message.setOneofWrapperField(this, 100, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
...
proto.endless.stream.v1.Input.prototype.setAudience = function(value) {
  return jspb.Message.setOneofWrapperField(this, 110, proto.endless.stream.v1.Input.oneofGroups_[0], value);
};
