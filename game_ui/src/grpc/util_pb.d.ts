...
export class Class extends jspb.Message {
  getClass(): ClassTypeMap[keyof ClassTypeMap];
  setClass(value: ClassTypeMap[keyof ClassTypeMap]): void;
...
export namespace Class {
  export type AsObject = {
    pb_class: ClassTypeMap[keyof ClassTypeMap],
  }
}
...
export const ClassType: ClassTypeMap;
...
export const StatusEffect: StatusEffectMap;
