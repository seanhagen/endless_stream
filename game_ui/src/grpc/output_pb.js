...
goog.exportSymbol('proto.endless.stream.v1.ProgressBarType', null, global);
...
proto.endless.stream.v1.Skill.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    upgradable: jspb.Message.getBooleanFieldWithDefault(msg, 9, false),
...
proto.endless.stream.v1.Player.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isAi: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
...
proto.endless.stream.v1.Monster.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isFlying: jspb.Message.getBooleanFieldWithDefault(msg, 4, false),
    isBoss: jspb.Message.getBooleanFieldWithDefault(msg, 5, false)
  };
...
proto.endless.stream.v1.EventMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    isAlert: jspb.Message.getBooleanFieldWithDefault(msg, 4, false),
    playerId: (f = msg.getPlayerId()) && google_protobuf_wrappers_pb.StringValue.toObject(includeInstance, f),
    logOnly: jspb.Message.getBooleanFieldWithDefault(msg, 6, false)
  };
...
proto.endless.stream.v1.Wave.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hasBoss: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
    level: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
proto.endless.stream.v1.Tick.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    progressMap: (f = msg.getProgressMap()) ? f.toObject(includeInstance, undefined) : []
  };
 ...
 * @return {!jspb.Map<string,number>}
 */
proto.endless.stream.v1.Tick.prototype.getProgressMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,number>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      null));
};
 ...
 * Clears values from the map. The map will be non-null.
 */
proto.endless.stream.v1.Tick.prototype.clearProgressMap = function() {
  this.getProgressMap().clear();
};
...
proto.endless.stream.v1.JoinedGame.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    asAudience: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
    isVip: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
...
proto.endless.stream.v1.Action.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    targetIdsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
 ...
 * @enum {number}
 */
proto.endless.stream.v1.ProgressBarType = {
