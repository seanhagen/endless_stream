...
// Create ...
func Create(_ context.Context, conf Config) (*Proxy, error) {
...
// Start ...
func (h *Proxy) Start(ctx context.Context) error {
...
// heartbeat ...
func (h *Proxy) heartbeat(ctx context.Context) {
...
// notifyHeartbeat ...
func (h *Proxy) notifyHeartbeat(ctx context.Context, t time.Time) {
...
// Stop ...
func (h *Proxy) Stop(ctx context.Context) error {
