...
abstract class AdminServiceBase extends $pb.GeneratedService {
  $async.Future<$3.AdminResponse> manage($pb.ServerContext ctx, $3.AdminRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'Manage': return $3.AdminRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'Manage': return this.manage(ctx, request as $3.AdminRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
